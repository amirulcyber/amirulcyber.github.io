...
permalink: /security/
description: Primary-source security artifacts — captured system prompts and research references, indexed by file.
---

Primary-source artifacts behind the research, published verbatim with provenance. Analysis lives on the [Blog](/blog/).
